...
This _base.yaml_ states that we want to use the kernel package _linux-image-unsigned-5.15.0-1034-s32-eb-optimized_, build an arm64 image, and task use of the default EBcL apt repository, and the EBcL NXP additions.
