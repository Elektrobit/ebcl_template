...
apt_repos:
  - apt_repo: https://linux.elektrobit.com/eb-corbos-linux/1.5pre
...
This _base.yaml_ states that we want to use the kernel package _linux-image-unsigned-5.15.0-1041-s32-eb-optimized_, build an arm64 image, and make use of the default EBcL apt repository, and the EBcL NXP additions.
...
packages:
  - linux-image-unsigned-5.15.0-1041-s32-eb-optimized
  - linux-modules-5.15.0-1041-s32-eb-optimized
  - linux-modules-extra-5.15.0-1041-s32-eb-optimized
  - u-boot-s32-tools
